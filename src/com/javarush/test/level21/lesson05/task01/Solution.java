...
//    @Override
//    public int hashCode() {
//        return 100 * first.length() + last.length();
//    }
    ...
    public static void main(String[] args) {
        ...
        s.add(new Solution("Ronald", "Duck"));
        Solution solution = new Solution("Donald", "Duck");
//        for (Solution iterator : s) {
//            System.out.println(iterator.first + " " + iterator.last + " : " + iterator.hashCode() + " : " + iterator.equals(new Solution("Donald", "Duck")));
//        }
