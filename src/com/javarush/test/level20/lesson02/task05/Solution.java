...
//            File your_file_name = File.createTempFile("your_file_name", null);
            java.lang.String fileName = "d:/c.txt";
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            printWriter.write(isString1Present);
            printWriter.write("\n");
            printWriter.flush();

            if (string1 != null)
                string1.save(outputStream);

            java.lang.String isString2Present = string2 != null ? "yes" : "no";
            printWriter.write(isString2Present);
            printWriter.write("\n");
            printWriter.flush();

            if (string2 != null)
                string2.save(outputStream);
        }
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            int realCountStrings = countStrings;
    ...
    public static class String {
        ...
        public void save(OutputStream outputStream) {
            PrintWriter printWriter = new PrintWriter(outputStream);
            printWriter.write(java.lang.String.valueOf(number));
            printWriter.write("\n");
            printWriter.flush();
        }
    }
